  ...
  return (
    <div>
        ...
        <div id="mining-news-section" className="w-[100%] flex flex-col justify-center items-center p-4  bg-white text-black">
          ...
          <div className=" flex flex-wrap p-2 justify-between text-sm text-center "> 
            <Link href="/mining-news/ml" className=''>
              <div className=" hover:shadow-lg bg-gray-100 transition-shadow rounded-lg duration-300 ease-in-out w-[45%] md:w-[200px] lg:w-[250px] m-2 text-xs">
            ...
            <Link href="/mining-news/ci" className=''>
            ...
            <Link href="/mining-news/gn" className=''>  
              <div className=" hover:shadow-lg bg-gray-100 transition-shadow rounded-lg duration-300 ease-in-out w-[45%] md:w-[200px] lg:w-[250px] m-2 text-xs">
                <div className="relative bg-black/90 p-8 rounded-t-lg">
            ...
            <Link href="/mining-news/bf" className=''>
              <div className=" hover:shadow-lg bg-gray-100 transition-shadow rounded-lg duration-300 ease-in-out w-[45%] md:w-[200px] lg:w-[250px] m-2 text-xs">
                <div className="relative bg-black/90 p-8 rounded-t-lg">
            ...
            <Link href="/mining-news/ne" className=''>  
              <div className=" hover:shadow-lg bg-gray-100 transition-shadow rounded-lg duration-300 ease-in-out w-[45%] md:w-[200px] lg:w-[250px] m-2 text-xs">
                <div className="relative bg-black/90 p-8 rounded-t-lg">
