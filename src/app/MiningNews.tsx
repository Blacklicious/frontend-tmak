...
const MiningNews = () => {
  return (
    <div>
        ...
        <div id="mining-news-section" className="w-[100vw]  flex flex-col justify-center items-center p-4  bg-white text-black">
          ...
          <div className="justify-center"> 
            <Link href="/mining-news/mali" className='flex flex-wrap justify-center text-sm text-center'>
              <div className="m-4 hover:shadow-lg transition-shadow rounded-lg duration-300 ease-in-out" style={{ width: '250px' }}>
                <div className="relative bg-black/90 p-8 rounded rounded-t-lg">
